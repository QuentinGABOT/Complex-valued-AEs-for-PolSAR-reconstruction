...
# Local imports
from cvnn.plugins import get_plugins, register_plugin
...
# Legacy dispatch dict for tests; points to plugin registry
# Note: This is populated after plugins are discovered
_TASKS = {}


# Populate _TASKS with discovered plugins (for test compatibility)
def _update_tasks_registry():
    global _TASKS
    _ensure_plugins_discovered()  # Trigger discovery
    _TASKS.update(get_plugins())


# Don't call this at module level to avoid circular imports
...
def run_experiment(
    ...
    # Also update legacy _TASKS for test compatibility
    global _TASKS
    _TASKS.update(available_tasks)
